        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate13DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate13DbContext>();
        ...
        public TestTemplate13DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate13DbContext> _options;
            ...
            {
                _options = new DbContextOptionsBuilder<TestTemplate13DbContext>()
            ...
            public TestTemplate13DbContext BuildContext() =>
                new(_options);
        }
    }
}
