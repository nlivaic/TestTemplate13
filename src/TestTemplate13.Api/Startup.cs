...
using TestTemplate13.Api.Helpers;
using TestTemplate13.Api.Middlewares;
using TestTemplate13.Application;
using TestTemplate13.Core;
...
namespace TestTemplate13.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TestTemplate13DbContext>(options =>
            {
                var sqlConnectionStringBuilder = new SqlConnectionStringBuilder(_configuration["TestTemplate13DbConnection"] ?? string.Empty);
            ...
            services.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    "TestTemplate13OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate13 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate13.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate13.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate13Client", builder =>
            {
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddEntityFrameworkOutbox<TestTemplate13DbContext>(o =>
                {
            ...
            services.AddTestTemplate13ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate13DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate13Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate13OpenAPISpecification/swagger.json", "TestTemplate13 API");
