...
using TestTemplate13.Common.MessageBroker.Middlewares.ErrorLogging;
using TestTemplate13.Common.MessageBroker.Middlewares.Tracing;
using TestTemplate13.Core;
using TestTemplate13.Core.Events;
using TestTemplate13.Data;
using TestTemplate13.WorkerServices.FaultService;
using TestTemplate13.WorkerServices.FooService;
...
namespace TestTemplate13.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information("Starting up TestTemplate13 Worker Services.");
            ...
            {
                Log.Fatal(ex, "TestTemplate13 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    {
                        var connString = new SqlConnectionStringBuilder(configuration["TestTemplate13DbConnection"]);
